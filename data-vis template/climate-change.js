      ...
      if (previous != null
        ...
        noStroke();
         fill( this.mapTemperatureToColour(previous.temperature) ,  
               this.mapTemperatureToColour(current.temperature) ,      
               this.mapTemperatureToColour(previous.temperature) );
         
           rect(this.mapYearToWidth(current.year) - 6, this.layout.topMargin , 
               segmentWidth , 
               this.layout.bottomMargin -35 ); 
